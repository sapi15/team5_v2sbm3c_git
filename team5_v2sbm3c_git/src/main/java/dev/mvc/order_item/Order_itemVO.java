 ...
 * */
  ...
  public String toString() {
    return "Order_itemVO [order_itemno=" + order_itemno + ", memberno=" + memberno + ", order_payno=" + order_payno
        + ", contentsno=" + contentsno + ", title=" + title + ", saleprice=" + saleprice + ", cnt=" + cnt + ", tot="
        + tot + ", stateno=" + stateno + ", rdate=" + rdate + "]";
  }
